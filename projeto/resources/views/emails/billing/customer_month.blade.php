...
@if(@$data['period_name'])
    <h5 style="font-size: 16px">Resumo de Faturação {{ $data['period_name'] }}</h5>
    <p>
        Estimado cliente,
        <br/>
...
@else
    <h5 style="font-size: 16px">Envio de Fatura</h5>
    <p>
        Estimado cliente,
        <br/>
        ...
        @else
            Junto enviamos a fatura referente aos serviços subscritos.
        @endif
    </p>
@endif
<p>
