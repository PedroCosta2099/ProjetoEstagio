...
@section('content')
<h5 style="font-size: 16px">Reenvio de Faturas</h5>
<p>
    Caro(a) cliente,
    <br/>
    @if($attachInvoice && $attachReceipt)
    Em anexo reenviamos as faturas abaixo listadas assim como os respetivos recibos.
    @elseif($attachInvoice && !$attachReceipt)
    Em anexo reenviamos as faturas abaixo listadas.
    @else
