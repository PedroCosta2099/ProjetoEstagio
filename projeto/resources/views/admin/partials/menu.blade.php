<aside class="main-sidebar hidden-print">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            {!! Html::sidebarOption('status', 'Estados dos Pedidos', route('admin.status.index')) !!}
            ...
            {!! Html::sidebarOption('paymentstatus', 'Estados dos Pagamentos', route('admin.paymentstatus.index')) !!}
            {!! Html::sidebarTreeClose() !!}
            @endif
