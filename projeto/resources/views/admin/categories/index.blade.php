        ...
        <div class="box no-border">
            <div class="box-body">
                <ul class="datatable-filters list-inline hide pull-left" data-target="#datatable">
                    ...
                    <li>
                        <a href="{{ route('admin.categories.create') }}" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-remote">
                            <i class="fas fa-plus"></i> Novo
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.categories.sort') }}" class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal-remote">
                ...
                <div class="selected-rows-action hide">
                    {{ Form::open(array('route' => 'admin.categories.selected.destroy')) }}
