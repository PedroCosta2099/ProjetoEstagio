...
<div class="modal-body">
    <button type="button" class="btn btn-xs btn-default alphabetically-sort" data-sort="asc">
        <i class="fas fa-sort-alpha-down"></i> Alfabéticamente [A-Z]
    </button>
    <button type="button" class="btn btn-xs btn-default alphabetically-sort" data-sort="desc">
        <i class="fas fa-sort-alpha-up"></i> Alfabéticamente [Z-A]
    </button>
    <div class="sp-15"></div>
    <ul class="list-sort-vertical list-unstyled sortable">
        ...
        @foreach($items as $key => $item)
            <?php $pos++; ?>
            <li data-id="{{ $item->id }}">
                <div class="pull-left">{{ $item->city }}</div>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary save-sort" data-loading-text="Gravar..." disabled>Gravar</button>
</div>
