...
class Vehicle extends BaseModel implements Sortable
{
     ...
     */
    protected $fillable = [
        'license_plate', 'name', 'agencies', 'gross_weight', 'usefull_weight', 'type', 'is_default', 'operator_id','status_id'
    ];
     ...
     * @return mixed
     */
    public static function listVehicles($isTrailer = false, $textField = 'license_plate', $idField = 'license_plate') {
